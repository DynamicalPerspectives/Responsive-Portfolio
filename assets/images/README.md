...
As a child, my dream job was to be a wildlife biologist and a photographer and writer for <i>The National Geographic Magazine</i>.  The question for me was "what are the avenues for getting to that point?" I studied law as a means of learning the finer points of writing as well get the opportunity to travel worldwide.  That effort paid off and I have spent 20 years as a technology and corporate lawyer
 ...
 <form action="/action_page.php">
              ...
              <br>
              Email<br>
              <input type="text" email="email" value="example@gmail.com">
              <br>
              Message<br>
              <input type="text" message="message" value="">
              <br>
